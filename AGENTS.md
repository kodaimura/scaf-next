...
- This repository is a Next.js, React, and TypeScript frontend scaffold.
...
- This project follows the App Router responsibility contract in `docs/ARCHITECTURE.md`.
