...
Next.js + React + TypeScript frontend scaffold.
...
Read [`docs/ARCHITECTURE.md`](docs/ARCHITECTURE.md) before changing App Router
entries, features, shared components, authentication state, or API
infrastructure. Pull requests run the same checks in GitHub Actions; see
